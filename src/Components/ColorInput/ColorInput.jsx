...
export default function ColorInput({ id, defaultValue }) {
  ...
  return (
    ...
    <>
      <input type="text" id={id} name={id} value={value} onChange={handleChange} /> {/* text input to write hex color value */}
      <input type="color" value={value} onChange={handleChange} /> {/* color input to pick color. type=color is HTML thing to work with RGB colors */}
    </>
  );
}
